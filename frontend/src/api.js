...
function buildDynamicFallbackCoach(body = {}) {
  ...
  const improvedByIntent = {
    leadership: `For "${question}", I would use STAR and focus on leadership actions. I set direction around ${anchor}, aligned cross-functional teammates on goals, and created a clear execution cadence. I delegated work by strengths, removed blockers quickly, and maintained transparent updates for stakeholders. The result was ${metric}% faster delivery and better team confidence. I will keep this answer concrete, people-focused, and outcome-driven.`,
    conflict: `For "${question}", I would show a real conflict and how I resolved it professionally. I had a disagreement around ${anchor}, so I first clarified shared goals, then used data and user impact to align decisions. I listened actively, documented trade-offs, and proposed a trial plan both sides could evaluate. We shipped with stronger alignment and improved quality by ${metric}%. This demonstrates calm communication, collaboration, and ownership under tension.`,
    failure: `For "${question}", I would acknowledge the mistake directly, explain what I learned, and show recovery. I made an incorrect assumption around ${anchor}, which affected timelines. I took ownership immediately, communicated impact early, and redesigned the plan with clear checkpoints. We recovered within two weeks and improved process quality by ${metric}%. The key is accountability, corrective action, and measurable learning.`,
    challenge: `For "${question}", I would frame the pressure clearly and walk through my decision process. The challenge centered on ${anchor} with tight deadlines and limited resources. I prioritized high-impact tasks, coordinated stakeholders, and used daily risk reviews to keep execution stable. We delivered with ${metric}% better speed while maintaining quality. This shows structured thinking and composure under pressure.`,
    behavioralGeneral: `For "${question}", I would answer with STAR and keep it specific. I faced a situation involving ${anchor}, took ownership, and executed a clear action plan with the team. I focused on decisions, communication, and risk management rather than generic claims. As a result, we improved outcomes by ${metric}% and left a repeatable process in place. This makes the answer credible and interview-ready.`,
    systemDesign: `For "${question}", I would begin with requirements, then propose architecture with trade-offs. I would design around ${anchor}, define throughput/latency targets, and explain failure handling. I would compare options, justify decisions, and include observability from day one. In a similar case, this approach improved p95 latency by ${metric}% in one month. This shows practical design thinking and scalability awareness.`,
    debugging: `For "${question}", I would explain a structured debugging strategy end-to-end. I would reproduce the issue around ${anchor}, narrow scope with logs/metrics, and isolate root cause before patching. Then I would add safeguards: alerts, tests, and rollback strategy. In my past work, this cut recurring incidents by ${metric}% over two sprints. This demonstrates reliability ownership and technical discipline.`,
    performance: `For "${question}", I would identify bottlenecks first and optimize in measured steps. I would baseline current behavior around ${anchor}, prioritize high-impact fixes, and validate each change with metrics. I would focus on caching, query/runtime efficiency, and concurrency trade-offs where relevant. This method improved latency by ${metric}% and increased throughput without instability. It demonstrates data-driven optimization.`,
    technicalGeneral: `For "${question}", I would clarify constraints, propose an implementable approach, and explain trade-offs around ${anchor}. I would cover edge cases, reliability, and validation strategy. In similar work, this approach improved key system metrics by ${metric}% in production. I would close with what I would monitor and optimize next. That communicates strong technical judgment.`,
  };
  const idealByIntent = {
